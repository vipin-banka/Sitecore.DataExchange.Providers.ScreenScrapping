...
{
    public class ReadSitemapStepConverter : BasePipelineStepConverter
    {
        private static readonly Guid TemplateId = Guid.Parse(Constants.Templates.PipelineSteps.ReadSitemapPipelineStepTemplateId);
        public ReadSitemapStepConverter(IItemModelRepository repository) : base(repository)
        {
