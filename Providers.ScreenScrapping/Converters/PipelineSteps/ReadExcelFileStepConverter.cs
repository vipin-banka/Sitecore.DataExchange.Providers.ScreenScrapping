...
{
    public class ReadExcelFileStepConverter : BasePipelineStepConverter
    {
        private static readonly Guid TemplateId = Guid.Parse(Constants.Templates.PipelineSteps.ReadExcelFilePipelineStepTemplateId);

        public ReadExcelFileStepConverter(IItemModelRepository repository) : base(repository)
        {
